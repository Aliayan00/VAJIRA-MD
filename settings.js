...
global.owner = process.env.OWNER_NUMBER  || '923169163193 ' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=WBkiBB5b#2MELivhbhWJzzJioBjNN7aerUBjpIrsMh_MpOBh7rck' ,
